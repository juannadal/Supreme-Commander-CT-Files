-----------------------------------------------------------------------------
--  File     : /units/uef/uum0001/uum0001_script.lua
--  Author(s): Drew Staltman, Aaron Lundquist, Gordon Duclos
--  Summary  : SC2 UEF Commander Escape Pod - UUM0001
...
UUM0001 = Class(AirUnit) {
    BeamExhaustIdle = { '/effects/emitters/units/uef/uul0001/event/escapepod/movement/uul0001_evt_e_m_04_beam_idle_emit.bp', },
    BeamExhaustCruise = { '/effects/emitters/units/uef/uul0001/event/escapepod/movement/uul0001_evt_e_m_01_beam_emit.bp',},
    ...
    OnStopBuild = function(self, unitBeingBuilt, order)
        ...
        if ( unitBeingBuilt and not unitBeingBuilt:IsDead() and not unitBeingBuilt:IsBeingBuilt() ) then
			...
			unitBeingBuilt:ShowBone('UUL0001_head',true)
    ...
    OnStartBuild = function(self, unitBeingBuilt, order)
		...
		unitBeingBuilt:HideBone('UUL0001_head',true)
