-----------------------------------------------------------------------------
--  File     : /units/cybran/ucb0025/ucb0025_script.lua
--  Author(s): Gordon Duclos, Aaron Lundquist
--  Summary  : SC2 Cybran Build Scaffolding: UCB0025
--  Copyright © 2009 Gas Powered Games, Inc.  All rights reserved.
-----------------------------------------------------------------------------
local ScaffoldUnit = import('/lua/sim/ScaffoldUnit.lua').ScaffoldUnit

UCB0025 = Class(ScaffoldUnit) {

	EffectAttachBones01 = {
		'UCB0025_T01_B01_Muzzle01',
		'UCB0025_T03_B01_Muzzle01',
		'UCB0025_T05_B01_Muzzle01',
	},
	
	EffectAttachBones02 = {
		'UCB0025_buildpoint01',
		'UCB0025_buildpoint03',
		'UCB0025_buildpoint05',
	},

	BotSpawnPoints = {
		'UCB0025_botEmitter01',
		'UCB0025_botEmitter03',
		'UCB0025_botEmitter05',
	},
	...
	SetupBuiltUnitInitialState = function(self)
		...
		if slideY != 0 and slideZ != 0 then
			WARN( 'ucb0025 Build scaffolding for unit ', self.unitBeingBuilt:GetUnitId(),  ' has build X and Z slide values set, which will have visible artifacts. Fix unit bp definition.' )
		end
	...
	StartBuildArmBeams = function(self)
		self:ForkThread( CreateCybranBuildBeams, self.unitBeingBuilt, {'UCB0025_T01_B01_Muzzle01',}, self.BuildEffectsBag )
		self:ForkThread( CreateCybranBuildBeams, self.unitBeingBuilt, {'UCB0025_T03_B01_Muzzle01',}, self.BuildEffectsBag )
		self:ForkThread( CreateCybranBuildBeams, self.unitBeingBuilt, {'UCB0025_T05_B01_Muzzle01',}, self.BuildEffectsBag )
