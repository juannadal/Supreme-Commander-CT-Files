-----------------------------------------------------------------------------
--  File     : /units/illuminate/uim0001/uim0001_script.lua
--  Author(s): Drew Staltman, Aaron Lundquist, Gordon Duclos
--  Summary  : SC2 Illuminate Commander Escape Pod - UIM0001
...
UIM0001 = Class(AirUnit) {
    BeamExhaustIdle = { '/effects/emitters/units/illuminate/uil0001/event/escapepod/movement/uil0001_evt_e_m_04_beam_idle_emit.bp', },
    BeamExhaustCruise = { '/effects/emitters/units/illuminate/uil0001/event/escapepod/movement/uil0001_evt_e_m_01_beam_emit.bp', },
    ...
    OnStopBuild = function(self, unitBeingBuilt, order)
        ...
        if ( unitBeingBuilt and not unitBeingBuilt:IsDead() and not unitBeingBuilt:IsBeingBuilt() ) then
			...
			unitBeingBuilt:ShowBone('UIL0001_Head',true)
    ...
    OnStartBuild = function(self, unitBeingBuilt, order)
		...
		unitBeingBuilt:HideBone('UIL0001_Head',true)
