...
function GetRandomName(faction, aiKey)
	LOG('GameSessionManager: GetRandomName (faction): ',faction)
...
function SetupCampaignSession(scenario, playerName, difficulty, inFaction, campaignFlowInfo, isTutorial)
	local factions = import('/lua/common/factions.lua').Factions
