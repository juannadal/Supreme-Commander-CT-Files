...
keyActions = {
    ...
    ['tog_military'] = {action =  'UI_Lua import("/lua/ui/game/multifunction.lua").ToggleMilitary()',
		category = 'ui', order = 5,},
    ['tog_intel'] = {action =  'UI_Lua import("/lua/ui/game/multifunction.lua").ToggleIntel()',
		category = 'ui', order = 5,},
    ['tog_strategic_overlay'] = {action =  'UI_Lua import("/lua/ui/game/multifunction.lua").ToggleStrategicView()',
		category = 'ui', order = 5,},
	['tog_stratmode_icons']= {action =  'ui_AlwaysRenderStrategicIcons',
        category = 'ui', order = 6,},
    ...
    ['switch_skin_up'] = {action =  'UI_RotateSkin +',
        category = 'ui', order = 17,},
    ['toggle_key_bindings'] = {action = 'UI_Lua UIShowKeyBindings()',
        category = 'ui', order = 6,},
    ['toggle_score_screen'] = {action =  'UI_Lua UIToggleScoreboard()',
        category = 'ui', order = 1,},
    ...
    ['toggle_main_menu'] = {action =  'UI_Lua UIToggleMainMenu()',
        category = 'ui', order = 4,},
    ...
    ['shift_dive'] = {action =  'IssueCommand Dive',
    ...
    ['pause_unit'] = {action =  'UI_Lua UIPauseConstructionUnit()',
        category = 'orders', order = 31,},
    ['mode'] = {action =  'UI_Lua UISetNextSelectionFireMode()',
    ...
    ['chat_page_up'] = {action = 'UIChatShow', category = 'chat', order = 2,},
    ['chat_page_down'] = {action = 'UIChatHide', category = 'chat', order = 3,},
    ...
    ['toggle_voice'] = {action = 'UIToggleVoice', category = 'chat', order = 6,},
    ['show_fps'] = {action = 'UI_Lua UIToggleFrameRate()', category = 'ui', order = 1,},
    ['print_buffs'] = {action =  'SimLua PrintBuffs()',
    	category = 'debug', order = 1,},
    ['toggle_research_menu'] = {action = 'ToggleResearchMenu', category = 'orders', order = 1,},
	['toggle_ui'] = {action = 'ren_ui', category = 'ui', order = 1,},

	['pullinsmash'] = {action = 'UICommandSpecAbil pullinsmash', category = 'orders', order = 33},
	['overcharge'] = {action = 'UICommandSpecAbil overcharge', category = 'orders', order = 34},
	['acu_hunker'] = {action = 'UICommandSpecAbil acu_hunker', category = 'orders', order = 35},
	['pullinsmash'] = {action = 'UICommandSpecAbil pullinsmash', category = 'orders', order = 36},
	['overcharge'] = {action = 'UICommandSpecAbil overcharge', category = 'orders', order = 37},
	['escapepod'] = {action = 'UICommandSpecAbil escapepod', category = 'orders', order = 38},
	['jump'] = {action = 'StartCommandMode order RULEUCC_Jump', category = 'orders', order = 39},
	['teleport'] = {action = 'StartCommandMode order RULEUCC_Teleport', category = 'orders', order = 40},

	['diag_toggle_netstats'] = { action =  'ren_ShowNetworkStats', category = 'ui', order = 41,},
	['diag_toggle_bandwidth'] = { action =  'ren_ShowBandwidthUsage', category = 'ui', order = 42,},

	['bombbouncercharge'] = {action = 'UICommandSpecAbil bombbouncercharge', category = 'orders', order = 43},
	['bombbouncermegablast'] = {action = 'UICommandSpecAbil bombbouncermegablast', category = 'orders', order = 43},

	['magnet'] = {action = 'UICommandSpecAbil magnet', category = 'orders', order = 43},
	['magnetpush']	= {action = 'UICommandSpecAbil magnetpush', category = 'orders', order = 43},

	['convertenergy'] = {action = 'UICommandSpecAbil convertenergy', category = 'orders', order = 43},
	['electroshock'] = {action = 'UICommandSpecAbil electroshock', category = 'orders', order = 44},
	['mobile_hunker'] = {action = 'UICommandSpecAbil mobile_hunker', category = 'orders', order = 45},
	['point_defense_hunker'] = {action = 'UICommandSpecAbil point_defense_hunker', category = 'orders', order = 46},
	['triarmorhalfspeed'] = {action = 'UICommandSpecAbil triarmorhalfspeed', category = 'orders', order = 47},
	['powerdetonate'] = {action = 'UICommandSpecAbil powerdetonate', category = 'orders', order = 48},
	['convertenergyid'] = {action = 'UICommandSpecAbil convertenergyid', category = 'orders', order = 49},

	['diag_toggle_frametime'] = { action =  'ren_ShowFrameTime', category = 'ui', order = 50,},
    ['pause_all'] = {action =  'UI_Lua UIPauseAllConstructionUnits()',
        category = 'orders', order = 31,},
    ['unpause_all'] = {action =  'UI_Lua UIUnPauseAllConstructionUnits()',
        category = 'orders', order = 31,},
...
debugKeyActions = {
    ...
    ['debug_grid'] = {action =  'dbg grid',
        category = 'debug', order = 1,},
    ['debug_gpnav_overlay'] = {action =  'gpnav_Overlay',
		category = 'debug', order = 1,},
    ...
    ['debug_show_emitter_window'] = {action =  'EFX_CreateEmitterWindow',
        category = 'debug', order = 1,},
    ['debug_reload_effect_templates'] = {action =  'simlua doscript("/lua/sim/EffectTemplates.lua")',
        category = 'debug', order = 1,},
    ['debug_reload_effect_utilities'] = {action =  'simlua doscript("/lua/sim/EffectUtilities.lua")',
        category = 'debug', order = 1,},
    ['debug_give_me_all_research'] = {action =  'CompleteAllResearch',
        category = 'debug', order = 1,},
    ...
    ['debug_cam_zoom_far'] = {action =  'Cam_NearZoom 40',
        category = 'debug', order = 1,},
    ['debug_cam_zoom_near'] = {action =  'Cam_NearZoom 1',
        category = 'debug', order = 1,},
    ['debug_set_unit_scale_up'] = {action = 'IncUnitScale',
		category = 'debug', order = 1, keyRepeat = true,},
	['debug_set_unit_scale_down'] = {action = 'DecUnitScale',
		category = 'debug', order = 1, keyRepeat = true,},
    ['debug_selected_attack_ground'] = {action = 'ProcessInfoPair "SetFireState" "FIRESTATE_HoldGround"',
        category = 'debug', order = 1,},
    ['debug_toggle_sound_info'] = {action =  'ren_ShowSoundInfo',
        category = 'debug', order = 1,},
    ['debug_toggle_sound_logging'] = {action =  'snd_LogEvents',
        category = 'debug', order = 1,},
    ['debug_toggle_ui'] = { action =  'ren_UI', category = 'debug', order = 1,},
}