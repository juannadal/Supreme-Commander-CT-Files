...
-- error messages
errorMsg = {
    zero = "A filename must have at least one character",
    toolong = "A filename can contain no more than %d characters",
    invalidchars = "A filename can not contain the characters \\ / : * ? < > | \" ' .",
    invalidlast = "A filename can not begin or end with a space or a period",
    invalidname = "You have requested an invalid file name",
}
...
local columConfigurations = {
    {
        {title = 'Name', width = 435, sortby = 'name', key = 'name'},
        {title = 'Date', width = 130, sortby = 'TimeStamp', key = 'date'},
    },
    {
        {title = 'Name', width = 267, sortby = 'name', key = 'name'},
        {title = '', width = 150, sortby = 'profile', key = 'owner'},
        {title = 'Date', width = 130, sortby = 'TimeStamp', key = 'date'},
    },
}
...
--]]----------------------------------------------------------------------------
        ...
        self._filenameLabel = UIUtil.CreateText(self, "Filename", 16, UIUtil.titleFont)
        ...
        if not onlyShowMine then
            ...
            self._onlyMineLabel = UIUtil.CreateText(self, "Show only my files", 12, UIUtil.titleFont)
