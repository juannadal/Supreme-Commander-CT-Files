...
skins = {
    uef = {
        ...
        buttonFont = "MagistralTT Bold",
	    factionFont = "MagistralTT Bold",
        bodyFont = "MagistralTT Bold",
        fixedFont = "Arial",
        titleFont = "MagistralTT Bold",
        fontColor = "FFbadbdb",
        bodyColor = "FF6FAFAF",
        dialogCaptionColor = "FFbadbdb",
        dialogColumnColor = "FF6FAFAF",
        dialogButtonColor = "FF69AB4D",
        dialogButtonFont = "MagistralTT Bold",
    ...
    default = {
        ...
        cursors = {
			...
			RULEUCC_Dock = {'/textures/ui/common/game/cursors/load-.dds', 15, 19, 14, 12},
			...
			RULEUCC_Jump = {'/textures/ui/common/game/cursors/move-.dds', 15, 15, 12, 12},
			RULEUCC_SiloBuildAntiNuke = {'/textures/ui/common/game/cursors/launch.dds', 15, 15},
			RULEUCC_SiloBuildRedirectNuke = {'/textures/ui/common/game/cursors/launch.dds', 15, 15},
			RULEUCC_SiloBuildNuke = {'/textures/ui/common/game/cursors/launch.dds', 15, 15},
			RULEUCC_SiloBuildEMP = {'/textures/ui/common/game/cursors/launch.dds', 15, 15},
            RULEUCC_Nuke = {'/textures/ui/common/game/cursors/launch.dds', 15, 15},
            RULEUCC_EMP = {'/textures/ui/common/game/cursors/launch.dds', 15, 15},
			...
			RULEUCC_Ability = {'/textures/ui/common/game/cursors/attack.dds', 15, 15},
            RULEUCC_Invalid = {'/textures/ui/common/game/cursors/attack-invalid.dds', 15, 15},
			RULEUCC_KillSelf = {'/textures/ui/common/game/cursors/selectable.dds', 2, 2},
            ...
            DEFAULT_GAMEPAD = {'/textures/ui/common/game/cursors/360_cursor.dds', 16, 16},
            ATTACK_GAMEPAD = {'/textures/ui/common/game/cursors/360_cursor_enemy.dds', 16, 16},
            ...
            MOVE_INVALID = {'/textures/ui/common/game/cursors/selectable-invalid.dds', 2, 2},
        },
    },
}