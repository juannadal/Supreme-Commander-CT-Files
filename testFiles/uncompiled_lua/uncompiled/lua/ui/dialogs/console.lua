...
function ConfigWindow(parent)
    ...
    window = Window(GetFrame(0), 'Console Config', nil, nil, nil, true)
    ...
    local label = UIUtil.CreateText(client, LOCF("Alpha: %d%%", defValue), 14)
    ...
    slider.OnValueChanged = function(self, newValue)
        ...
        label:SetText(LOCF("Alpha: %d%%", newValue))
    end
...
function CreateDialog()
    ...
    parent = Window(mainFrame, 'Console', nil, nil, true, false, false, 'console_window', location)
