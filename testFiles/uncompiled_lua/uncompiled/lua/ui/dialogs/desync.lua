...
function UpdateDialog(beatNumber, strings)
    if not dialog then
        ...
        local title = UIUtil.CreateText(bg, "Desync Detected", 14, UIUtil.titleFont)
        ...
        local okBtn = UIUtil.CreateButtonStd(bg, '/widgets/small', "Ok", 10)
    ...
    dialog.textControls[9]:SetText(LOC("Beat-- ") .. tostring(beatNumber))
end