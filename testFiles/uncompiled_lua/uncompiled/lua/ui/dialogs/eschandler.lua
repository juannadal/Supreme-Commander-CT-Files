...
function HandleEsc(yesNoOnly)
    ...
    local function CreateYesNoDialog()
        ...
        GetCursor():Show()
        quickDialog = UIUtil.QuickDialog(GetFrame(0), "Are you sure you'd like to quit?",
            "Yes", function() ExitApplication() end,
            "No", function() quickDialog:Destroy() quickDialog = false end,
            nil, nil,
            true,
