...
function CreateDialog(parent, initialRestrictions, OnOk, OnCancel, isHost)
    ...
    local title = UIUtil.CreateText(dialog, "Unit Manager", 20, UIUtil.titleFont)
    LayoutHelpers.AtTopIn(title, dialog.border.tm, 12)
    LayoutHelpers.AtHorizontalCenterIn(title, dialog)

    local cancelBtn = UIUtil.CreateButtonStd(dialog, '/scx_menu/small-btn/small', "Close", 16, 2, 0, "UI_Menu_Cancel_02", "UI_Opt_Affirm_Over")
    ...
    if isHost == true then
        ...
        okBtn = UIUtil.CreateButtonStd(dialog, '/scx_menu/small-btn/small', "Ok", 16, 2, 0, "UI_Opt_Yes_No", "UI_Opt_Affirm_Over")
        LayoutHelpers.Below(okBtn, dialog, -20)
        LayoutHelpers.AtLeftIn(okBtn, dialog, -50)
        LayoutHelpers.RightOf(cancelBtn, okBtn)

        resetBtn = UIUtil.CreateButtonStd(dialog, '/scx_menu/small-btn/small', "Reset", 16, 2, 0, "UI_Opt_Yes_No", "UI_Opt_Affirm_Over")
