...
maxPlayerSlots = 8
maxConnections = 11 -- count doesn't include ourself.
...
function GetDefaultPlayerOptions(playerName)
    return {
        ...
        StartSpot = 1,
        Ready = false,
        Faction = table.getn(import('/lua/common/factions.lua').Factions) + 1, --max faction + 1 tells lobby to pick random faction
