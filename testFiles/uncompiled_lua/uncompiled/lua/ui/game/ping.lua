...
PingTypes = {
    alert = {Lifetime = 6, Mesh = 'alert_marker', Ring = '/game/marker/ring_yellow02-blur.dds', ArrowColor = 'yellow', Sound = 'snd_UI_PC_Frontend_Select'},
    move = {Lifetime = 6, Mesh = 'move', Ring = '/game/marker/ring_blue02-blur.dds', ArrowColor = 'blue', Sound = 'snd_UI_PC_Frontend_Select'},
    attack = {Lifetime = 6, Mesh = 'attack_marker', Ring = '/game/marker/ring_red02-blur.dds', ArrowColor = 'red', Sound = 'snd_UI_PC_Frontend_Select'},
...
function DisplayPing(data)
    ...
    for index, ping in data do
        ...
        if ping.Sound and not ping.Renew then
            PlaySound(Sound{Bank = 'SC2/Interface/Frontend', Cue = ping.Sound})
        end
    end
end
