...
---- Move Orders
    default_MoveColors = {
        orderline_color = 'dd346fbe',           
        orderline_selected_color = 'ff4f9aff',  
        orderline_highlight_color = 'ff8ac1ff',   
    },
   ...
   UNITCOMMAND_Move = {
    ...
    UNITCOMMAND_Jump = { inherit_from = 'UNITCOMMAND_Move' },
