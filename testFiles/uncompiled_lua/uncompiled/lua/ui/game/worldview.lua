...
function CreateMainWorldView(parent, mapGroup, mapGroupRight)    
    ...
    if mapGroupRight then
        ...
        viewLeft:SetRenderPass(bitlib.bor(UIUtil.UIRP_UnderWorld,UIUtil.UIRP_PostGlow)) -- don't change this or the camera will lag one frame behind
        ...
        viewRight:SetRenderPass(bitlib.bor(UIUtil.UIRP_UnderWorld,UIUtil.UIRP_PostGlow)) -- don't change this or the camera will lag one frame behind
