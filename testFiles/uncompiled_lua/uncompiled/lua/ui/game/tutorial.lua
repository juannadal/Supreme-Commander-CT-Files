...
function AddCameraMarkers(inMarkers)
    for _, marker in inMarkers do
        ...
        -- Brian Fricks told me to do it SB 11.30.09; this is to keep the ugly marker from appearing during
        -- the camera objectives in the SC2 tutorial
        mesh:SetHidden(true)
        ...
        if table.getsize(markers) > 0 then
            ...
            for markerid, markerInfo in markers do
                ...
                if valid then
                    ...
                    markerInfo.mesh:SetHidden(true)
