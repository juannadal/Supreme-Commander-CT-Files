...
function UpdateWindow(info)
    if info.blueprintId == 'unknown' then
        ...
        local bp = GetUnitBlueprintByName(info.blueprintId)
        ...
        -- modified description to use the bdID instead of the Tech level - this is a useful dev convention for prototyping - bfricks 3/17/09
...
--		SC2: Veterancy has changed for SC2, we still will want this UI, however this is all depends on the new UI structure.
