...
function Toggle(section)
	...
	dialog.Left:Set( 0 )
	dialog.Right:Set( 250 )
	dialog.Top:Set( 50 )
	dialog.Bottom:Set( 400 )
	...
	statList.Left:Set( 0 )
	statList.Right:Set( 250 )
	statList.Top:Set( 50 )
	statList.Bottom:Set( 400 )
	statList:SetFont('Andale Mono', 12)
	statList:SetColors('FFFFFF00','90000000','FFFFFF00','FF0000FF')
	local sb = UIUtil.CreateVertScrollbarFor(statList)
	sb.Left:Set(statList.Right)
