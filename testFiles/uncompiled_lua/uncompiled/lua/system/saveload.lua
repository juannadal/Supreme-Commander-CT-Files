...
-- Kore specific
export_funs('io', io)
export_funs('package', package)
export_funs('profile', profile)
export_funs('os', os)
export_funs('kore', kore)
export_name('kore_io_stdin', io.stdin)
export_name('kore_io_stdout', io.stdout)
export_name('kore_io_stderr', io.stderr)
