...
-- If file does not exist function returns nil and no error messages are displayed
function importConditional(name)
    ...
    local ok, msg = pcall(doscriptConditional, name, env)
