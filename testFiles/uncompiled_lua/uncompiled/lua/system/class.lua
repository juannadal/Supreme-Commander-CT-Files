...
--------------------------------------------------------------------------------------------------------------------------
-- Light Class
-- A Classy Lua Implementation
--------------------------------------------------------------------------------------------------------------------------

local function makeInst( self, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, argLimit ) 
    assert( argLimit == nil )
    ...
    if instance.OnCreate then
        instance.OnCreate( instance, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, argLimit )
    end

    return instance
end

function LightClass( specTable )
    setmetatable( specTable, {__call = makeInst})
    return specTable
end

function Extends( parent )
    return function( specTable )
        setmetatable( specTable, {__call = makeInst, __index = parent})
        return specTable
    end
end

--multiple inheritance is dumb and slow
function Extends2( parent1, parent2 )
    return function( specTable )
        setmetatable( specTable, {__call = makeInst, __index = function(t,k) return parent1[k] or parent2[k] or rawget(t,k) end} )
        return specTable
    end
end

function Extends3( parent1, parent2, parent3 )
    return function( specTable )
        setmetatable( specTable, {__call = makeInst, __index = function(t,k) return parent1[k] or parent2[k] or parent3[k] or rawget(t,k) end} )
        return specTable
    end
end