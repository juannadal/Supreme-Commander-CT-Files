-----------------------------------------------------------------------------
--  File     :  /effects/entities/e3nukeeffect01/uefnukeeffectcontroller01_script.lua
--  Author(s):  Gordon Duclos
--  Summary  :  E3 Nuke Effect
...
E3NukeEffect01 = Class(Projectile) {
    ...
    EffectThread = function(self)
        ...
        -- Base flash
		for k, v in EffectTemplates.TNukeBaseEffects03 do
