-----------------------------------------------------------------------------
--  File     : /projectiles/illuminate/itacticalmissile02/itacticalmissile02_script.lua
--  Author(s): Gordon Duclos, Aaron Lundquist
--  Summary  : SC2 Illuminate (LONG RANGE) Tactical Missile: ITacticalMissile02
--  Copyright © 2009 Gas Powered Games, Inc.  All rights reserved.
-----------------------------------------------------------------------------
local Projectile = import('/lua/sim/Projectile.lua').Projectile

ITacticalMissile02 = Class(Projectile) {
