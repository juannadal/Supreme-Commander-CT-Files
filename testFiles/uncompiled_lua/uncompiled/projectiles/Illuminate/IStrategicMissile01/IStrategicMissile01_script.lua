-----------------------------------------------------------------------------
--  File     : /projectiles/illuminate/istrategicmissile01/istrategicmissile01_script.lua
--  Author(s): Gordon Duclos
--  Summary  : SC2 Illuminate Strategic Missile: IStrategicMissile01
--  Copyright © 2009 Gas Powered Games, Inc.  All rights reserved.
-----------------------------------------------------------------------------
local Projectile = import('/lua/sim/Projectile.lua').Projectile
local VizMarker = import('/lua/sim/VizMarker.lua').VizMarker

IStrategicMissile01 = Class(Projectile) {
	...
	InitialEffects = {
		'/effects/emitters/weapons/illuminate/nuke01/launch/w_i_nuke01_l_07_core_emit.bp',
	},
	LaunchEffects = {
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_06_fxtrails_emit.bp',
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_07_fxtrails_emit.bp',
	},
    ThrustEffects = {
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_01_core_emit.bp',
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_02_glow_emit.bp',
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_03_distortwake_emit.bp',
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_04_debris_emit.bp',
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_05_plasma_emit.bp',
		'/effects/emitters/weapons/illuminate/nuke01/projectile/w_i_nuke01_p_08_flash_emit.bp',
	},
