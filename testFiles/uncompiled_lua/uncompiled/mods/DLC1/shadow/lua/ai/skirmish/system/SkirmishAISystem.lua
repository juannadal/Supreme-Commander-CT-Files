...
SkirmishAISystem = Class() {
    ...
    SkirmishDelaySetup = function(self)
        ...
        WARN('*AI DEBUG: Using archetype - ' .. self.Brain.CurrentPlan)
		WARN('*AI DEBUG: AI Archetype:' .. self.Brain.AIArchetype .. ' Build Bonus: ' .. self.Brain.BuildBonus .. ' Res Bonus ' .. self.Brain.ResBonus .. ' Vet Bonus: ' .. self.Brain.VetBonus ..
