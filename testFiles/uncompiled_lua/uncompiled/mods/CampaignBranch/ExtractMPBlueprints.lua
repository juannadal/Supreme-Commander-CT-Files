...
local uefdir = '../../Units/UEF/'
local illuminatedir = '../../Units/Illuminate/'
local cybrandir = '../../Units/Cybran/'
local datadir = '../../'
...
function LoadAllBlueprints()
    ...
    print('=======================================================')
    print('Reading Illuminate blueprints...' )
    print('=======================================================')

    for i,d in io.dir(illuminatedir .. '*.*') do
    -- To use only those in given table
    -- for i,d in specificUnits do
        current_id = string.lower(d)
        local filename = string.format(illuminatedir .. '%s/%s_unit.bp', d, d)
        print( filename )
    ...
    print('=======================================================')
    print('Reading Cybran blueprints...' )
    print('=======================================================')

    for i,d in io.dir(cybrandir .. '*.*') do
    -- To use only those in given table
    -- for i,d in specificUnits do
        current_id = string.lower(d)
        local filename = string.format(cybrandir .. '%s/%s_unit.bp', d, d)
        print( filename )
