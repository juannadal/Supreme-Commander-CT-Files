function OnPopulate()
	...
	local camData = {
		...
		MaxZoomMult		= 1.2,		-- 1.1 = default	Extra zoom out buffer so we can see the borders of the map clearly.
	...
	import('/lua/sim/ScenarioFramework.lua').SetPlayableArea('AREA_01')
end
